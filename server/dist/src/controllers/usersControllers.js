...
const hasing_password_js_1 = require("../utils/hasing-password.js");
const bcryptjs_1 = __importDefault(require("bcryptjs"));
const takenUtils_js_1 = require("../utils/takenUtils.js");
const createUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { name, email } = req.body;
        const hashedPassword = yield (0, hasing_password_js_1.hashingPassword)(req.body.password);
        ...
        db_js_1.pool.query(db_query_js_1.createNewUser, values, (error, results) => {
            if (error) {
                console.log(error);
...
const deleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const values = [id];
        db_js_1.pool.query(db_query_js_1.deleteUserQuery, values, (error, results) => {
            if (error)
                return error;
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const values = [email];
        db_js_1.pool.query(db_query_js_1.findUserQuery, values, (error, results) => __awaiter(void 0, void 0, void 0, function* () {
            if (error) {
                console.log(error);
            ...
            const userid = 'abc123';
            const token = (0, takenUtils_js_1.createJWT)(userid);
